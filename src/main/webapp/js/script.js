var app = angular.module("StarterApp", ["ngRoute","ngMaterial", "ngMdIcons", "ngSanitize", "mdDataTable"]);
...
app.controller('companiesController', ['$scope','companiesFactory', function ($scope, peopleFactory) {
